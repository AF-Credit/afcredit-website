(function () {
  ...
  var LOGO_HTML = function(href, white) {
    var src = white
      ? root + 'images/AF Credit White Logo.png'
  ...
  var FOOTER = '<footer class="site-footer">'
    ...
    + '<p>AF Credit is a trading style of Chammosair Limited and its associated companies, registered in England and Wales (Company No. 15786496). Registered with the Information Commissioner\'s Office (ICO) under Registration Reference ZB729589.</p>'
    + '</div>'
    + '</footer>';
